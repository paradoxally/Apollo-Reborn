...
NSString *sAISummaryProvider = @"apple"; // sanitized to apple|openai|openrouter|gemini|custom on load
NSString *sOpenAIAPIKey = nil;
NSString *sOpenAIAIModel = nil;
