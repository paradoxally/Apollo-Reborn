...
static const ApolloWhatsNewReleaseEntry kWhatsNewReleases[] = {
    ...
    { "3.17.0", "What's New in Apollo Reborn" },
    { "3.18.0", "What's New in Apollo Reborn" },
    { "3.19.0", "What's New in Apollo Reborn" },
    { "3.20.0", "What's New in Apollo Reborn" },
...
static const ApolloWhatsNewItemEntry kWhatsNewItems[] = {
    ...
    { "3.17.0", "clock.arrow.circlepath", "Automatic Backups", "Apollo can write a settings backup to a folder you pick in Files every day, every three days or every seven days. Off by default, under Settings > Apollo Reborn > Backup Settings." },
    { "3.17.0", "folder.fill", "Manage Backups", "See every backup on the device, split into Automatic and Manual. The newest ten automatic backups are kept; manual ones stay until you delete them." },
    { "3.17.0", "hand.draw.fill", "Smoother Scrolling", "Scrolling back down right after reaching the top of a post no longer pauses while Find in Comments settles." },
    { "3.17.0", "checkmark.circle.fill", "Header Stays Put While Editing", "With Hide Header on Scroll enabled, the checkmark stays reachable while you reorder the subreddit list or use the alphabet index." },
    { "3.18.0", "person.2.fill", "Redesigned Account Switcher", "A full-width bottom sheet in your theme's colours, with larger avatars, a drag handle for reordering and each account's menu on its own ellipsis." },
    { "3.18.0", "square.on.circle", "Profile Picture Shape", "Choose Full, Circle or rounded Square for user pictures across posts, comments, messages and the profile tab. Under Settings > Apollo Reborn > Interface." },
    { "3.18.0", "hand.draw.fill", "Swipe Tab Bar to Navigate", "On Liquid Glass, swiping the tab bar goes back and forward again, in exchange for the system's drag-to-switch-tab gesture. Off by default, under Interface > Tab Bar." },
    { "3.18.0", "arrow.up.arrow.down", "Tabs Remember Their Sort", "Reopening a Floating Post Tab from its bubble brings the thread back on the sort you left it on, Live Update included." },
    { "3.18.0", "keyboard", "iOS 27 Composer Fix", "The formatting bar above the keyboard no longer sits under it, so the photo, GIF, link and text icons are whole again." },
    { "3.19.0", "square.and.arrow.down.on.square", "Save All Media", "Save every image, GIF and video in a gallery, Imgur album or ImageChest post at once, from the full-screen and long-press menus." },
    { "3.19.0", "gearshape.fill", "Settings Shortcuts", "Press and hold the Settings tab to jump straight to up to 15 settings pages. Choose them under Interface > Tab Bar." },
    { "3.19.0", "eye.slash.fill", "Redesigned Hidden & Deleted", "A native feed of archived posts and comments, with status flairs, inline albums and its own row on the profile." },
    { "3.19.0", "list.bullet", "Smoother List Editing", "Animated edit controls, aligned favourite stars and rows that shrink away when you remove them." },
    { "3.19.0", "sparkles", "Cloud AI on GPT-6", "Summaries work on the new gpt-6 models, and adapt on their own to models Apollo doesn't know yet." },
    { "3.20.0", "ellipsis.circle.fill", "Action Menus", "Reorder or hide the actions in each \342\200\242\342\200\242\342\200\242 and moderator menu, with a live preview. Find it under Interface > Menus." },
    { "3.20.0", "play.rectangle.fill", "Smoother Video Feeds", "Video players get ready in the background, so video-heavy subreddits scroll without hitches." },
    { "3.20.0", "person.crop.circle.fill", "Immersive Profiles", "Banner art now runs behind the bars. Long-press a banner to view it full-screen and save it." },
    { "3.20.0", "text.bubble.fill", "Chat Drafts", "Unsent messages in modern Direct Chat are kept for each account and conversation." },
    { "3.20.0", "star.fill", "Confirm Favorite Changes", "Have the star on the Subreddits list ask before adding or removing a favourite. Off by default." },
